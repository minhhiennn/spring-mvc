...
<body>
	...
	<section class="hero-area bg-img bg-overlay-2by5"
		style="background-image: url(/spring-mvc/template/img/bg-img/bg1.jpg);">
			...
			<div class="row">
				...
				<div class="col-12 col-sm-6 col-lg-3">
					<div class="single-cool-facts-area text-center mb-100 wow fadeInUp"
						...
						<div class="icon">
							<img src="/spring-mvc/template/img/core-img/docs.png" alt="">
						</div>
						<h2>
				...
				<div class="col-12 col-sm-6 col-lg-3">
					<div class="single-cool-facts-area text-center mb-100 wow fadeInUp"
						...
						<div class="icon">
							<img src="/spring-mvc/template/img/core-img/star.png" alt="">
						</div>
						<h2>
				...
				<div class="col-12 col-sm-6 col-lg-3">
					<div class="single-cool-facts-area text-center mb-100 wow fadeInUp"
						...
						<div class="icon">
							<img src="/spring-mvc/template/img/core-img/events.png" alt="">
						</div>
						<h2>
				...
				<div class="col-12 col-sm-6 col-lg-3">
					<div class="single-cool-facts-area text-center mb-100 wow fadeInUp"
						...
						<div class="icon">
							<img src="/spring-mvc/template/img/core-img/earth.png" alt="">
						</div>
						<h2>
	...
	<section class="popular-courses-area section-padding-100-0"
		style="background-image: url(/spring-mvc/template/img/core-img/texture.png);">
		<div class="container">
			<div class="row">
				<div class="col-12">
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-popular-course mb-100 wow fadeInUp"
						data-wow-delay="250ms">
						<img src="/spring-mvc/template/img/bg-img/c1.jpg" alt="">
						<!-- Course Content -->
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-popular-course mb-100 wow fadeInUp"
						data-wow-delay="500ms">
						<img src="/spring-mvc/template/img/bg-img/c2.jpg" alt="">
						<!-- Course Content -->
						<div class="course-content">
							<h4>Vocabulary</h4>
							<div class="meta d-flex align-items-center">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-popular-course mb-100 wow fadeInUp"
						data-wow-delay="750ms">
						<img src="/spring-mvc/template/img/bg-img/c3.jpg" alt="">
						<!-- Course Content -->
						<div class="course-content">
	...
	<section class="best-tutors-area section-padding-100">
		<div class="container">
			...
			<div class="row">
				<div class="col-12">
					<div class="tutors-slide owl-carousel wow fadeInUp"
						data-wow-delay="250ms">
						...
						<div class="single-tutors-slides">
							...
							<div class="tutor-information text-center">
								...
								<span>Teacher</span>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
									Morbi fermentum laoreet elit, sit amet tincidunt mauris
									ultrices vitae.</p>
	...
	<section
		...
		<div class="register-now-countdown mb-100 wow fadeInUp"
			...
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi
				fermentum laoreet elit, sit amet tincidunt mauris ultrices vitae.
				Donec bibendum tortor sed mi faucibus vehicula. Sed erat lorem</p>
			<!-- Register Countdown -->
	...
	<section class="upcoming-events section-padding-100-0">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-upcoming-events mb-50 wow fadeInUp"
						data-wow-delay="250ms">
						<!-- Events Thumb -->
						<div class="events-thumb">
							<img src="/spring-mvc/template/img/bg-img/e1.jpg" alt="">
						...
						<div class="date-fee d-flex justify-content-between">
							<div class="date">
								<p>
									<i class="fa fa-clock"></i> August 26 @ 9:00 am
								</p>
							</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-upcoming-events mb-50 wow fadeInUp"
						...
						<!-- Events Thumb -->
						<div class="events-thumb">
							<img src="/spring-mvc/template/img/bg-img/e2.jpg" alt="">
						...
						<div class="date-fee d-flex justify-content-between">
							<div class="date">
								<p>
									<i class="fa fa-clock"></i> August 7 @ 9:00 am
								</p>
							</div>
							<div class="events-fee">
								<a href="#" class="free">Free</a>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-upcoming-events mb-50 wow fadeInUp"
						...
						<!-- Events Thumb -->
						<div class="events-thumb">
							<img src="/spring-mvc/template/img/bg-img/e3.jpg" alt="">
						...
						<div class="date-fee d-flex justify-content-between">
							<div class="date">
								<p>
									<i class="fa fa-clock"></i> August 3 @ 9:00 am
								</p>
							</div>
							<div class="events-fee">
								<a href="#">$45</a>
			...
			<div class="row">
				...
				<div class="col-12 col-md-6">
					<div class="single-blog-area mb-100 wow fadeInUp"
						data-wow-delay="250ms">
						<img src="/spring-mvc/template/img/blog-img/1.jpg" alt="">
						<!-- Blog Content -->
				...
				<div class="col-12 col-md-6">
					<div class="single-blog-area mb-100 wow fadeInUp"
						data-wow-delay="500ms">
						<img src="/spring-mvc/template/img/blog-img/2.jpg" alt="">
						<!-- Blog Content -->
						<div class="blog-content">
							<a href="#" class="blog-headline">
								<h4>English Grammer</h4>
